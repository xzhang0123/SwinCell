...
def compute_masks(dP, cellprob, p=None, niter=200, 
    ...
    #---------------------------------------------------------------------------
    #print('input of compute masks function',dP.shape,cellprob.shape)
    #import tifffile
    #tifffile.imwrite('test_dp'+str(do_3D)+'.tiff',dP)
    #tifffile.imwrite('test_cellprob'+str(do_3D)+'.tiff',cellprob)
    #print('intermidate data saved')
    #-------------------------------------------------------------
    ...
    #tifffile.imwrite('test_res_mask',mask)
    #tifffile.imwrite('test_res_p',p)
    return mask, p
