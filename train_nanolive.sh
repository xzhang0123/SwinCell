...
for fold in {1..5}
do
	python ./swincell/train_main.py --data_dir=$data_dir --val_every=1 --distributed --model 'swin' --a_min=$v_min --a_max=$v_max --logdir $log_dir --max_epochs 5 --dsp 1 --fold $fold \
